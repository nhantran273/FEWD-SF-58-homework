...
function rockpapsci(humanPlay, computerPlay) {
  console.log('You have ' + humanPlay + '. The bot played ' + computerPlay + '.')

  if (humanPlay === computerPlay) {
    console.log('You tied. :|');
  } else if (humanPlay === 'paper' && computerPlay === 'rock' || humanPlay === 'rock' && computerPlay === 'scissors'
